...
export const Request = () => {
  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/home/request`, {
  ...
  const approve = async (user) => {
    try {
      await axios.post(`${import.meta.env.VITE_BACKEND_URL}/home/request/approved`,
  ...
  const reject = async (user) => {
    try {
      await axios.post(`${import.meta.env.VITE_BACKEND_URL}/home/request/rejected`,
