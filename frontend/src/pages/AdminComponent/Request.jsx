...
export const Request = () => {
  ...
  const axiosResponse = await axios.get('http://localhost:3000/home/request',
    {headers: {
...
// console.log("data after refresh ", data);
 const aproved = async(user) =>{
  ...
  try {
      const res =await  axios.post('http://localhost:3000/home/request/approved',{name,email,aprove},
    {
      headers: {
                'Content-Type': 'application/json'
              }
 ...
 const reject = async(user) =>{
  ...
  const res =await  axios.post('http://localhost:3000/home/request/rejected',{name,email,aprove},
    {
      headers: {
                'Content-Type': 'application/json'
              }
